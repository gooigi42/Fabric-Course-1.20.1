...
public class ModPlacedFeatures {
    ...
    public static final RegistryKey<PlacedFeature> NODE_TEST_PLACED_KEY = registerKey("node_test_placed");
    ...
    public static void bootstrap(Registerable<PlacedFeature> context) {
        ...
        register(context, NODE_TEST_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.NODE_TEST));
    }
